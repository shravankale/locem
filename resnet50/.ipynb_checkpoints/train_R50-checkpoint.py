...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = "../data/metadata_imgnet_vid_train_n4.pkl"
    #best val dataset has _new
    val_dataset = "../data/metadata_imgnet_vid_val_n4.pkl"
    ...
    if args.evaluate:
        from resnet_INVGen_V3 import ImageNetGeneratorV3
        ...
        val_loader = DataLoader(gen_val,batch_size=2879)
