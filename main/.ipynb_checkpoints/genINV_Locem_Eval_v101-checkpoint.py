...
class ImageNetVID(data.Dataset):
    ...
    def getOtherObjects(self,sample,train_data,all_data):
        ...
        return boxes,classnames,filenames
    ...
    def __getitem__(self,idx):
        ...
        other_sample_boxes,other_sample_classnames,other_sample_filenames = self.getOtherObjects(sample,self.data_set,self.all_data)
        ...
        return [sample_img,sample_bbox,class_name,file_name]
